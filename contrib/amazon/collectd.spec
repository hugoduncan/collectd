...
Group:         System Environment/Daemons
Requires:      collectd-java%{?_isa} = %{version}-%{release}
...
Group:         System Environment/Daemons
Requires:      collectd%{?_isa} = %{version}-%{release}
Requires:      collectd-rrdtool%{?_isa} = %{version}-%{release}
...
- Explicitly compile against Java 1.6.0

* Wed Sep 3 2014 Ben Cressey <bcressey@amazon.com>
- add arch-specific requires to plugin packages
- conditionalize ascent, pinba, riemann plugins

* Wed Mar 26 2014 Lee Trager <ltrager@amazon.com>
- bcond unsupported features

* Tue Mar 25 2014 Lee Trager <ltrager@amazon.com>
- import source package F20/collectd-5.4.1-1.fc20
...
* Tue Apr 10 2012 Cristian Gafton <gafton@amazon.com>
- update build requires for perl
- udpate to version 5.0.4
...
* Tue Feb 7 2012 Andrew Jorgensen <ajorgens@amazon.com>
- re-add mysql to BuildRequires
- enable iptables
- Fix CFLAGS passing

* Mon Feb 6 2012 Andrew Jorgensen <ajorgens@amazon.com>
- Update to version 5.0.2

* Thu Jan 12 2012 ltrager <ltrager@amazon.com>
- Add build dep for MySQL 5.5
...
* Wed Aug 17 2011 Nathan Blackham <blackham@amazon.com>
- Enabling the Java plugin.

* Tue Aug 2 2011 Andrew Jorgensen <ajorgens@amazon.com>
- remove arch-specific sensors conditional
- Disable sensors sub-package
...
* Wed Jul 20 2011 Nathan Blackham <blackham@amazon.com>
- Fix error with perl plugins not finding libperl.so

* Wed Jul 20 2011 Petr Sabata <contyk@redhat.com> - 4.10.3-6
- Perl mass rebuild

* Tue Jul 19 2011 Nathan Blackham <blackham@amazon.com>
- fix strict subs errors in perl bindings module

* Fri Jul 8 2011 Nathan Blackham <blackham@amazon.com>
- Update to 5.0.0 Add threshold plugin (new to 5.0.0) Add collectdctl (new to 5.0.0) Conditionalize nut, ping, libvirt plugins
- import source package GOBI/collectd-4.10.3-1.el6

* Fri Jul 08 2011 Kevin Fenzi <kevin@scrye.com> - 4.10.3-5
- Rebuild for new snmp

* Tue Jul 5 2011 Nathan Blackham <blackham@amazon.com>
- setup complete for package collectd
